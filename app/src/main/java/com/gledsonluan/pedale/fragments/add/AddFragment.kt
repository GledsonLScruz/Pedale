...
import com.gledsonluan.pedale.databinding.FragmentAddBinding
import com.gledsonluan.pedale.utils.hideKeyboard
import com.gledsonluan.pedale.utils.navigateWithAnimations
import java.util.*
...
class AddFragment : Fragment() {
    ...
    private fun sendDataToViewModel() {
        ...
        if(inputCheck(name,description,datepedals)){
            ...
            findNavController().navigateWithAnimations(com.gledsonluan.pedale.fragments.add.AddFragmentDirections.actionAddFragmentToAddTwoFragment())
        }else{
